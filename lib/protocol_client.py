from lib.logger import NORMAL_VERBOSITY, HIGH_VERBOSITY
import os
import sys
...
class ProtocolClient:
    ...
    def send_file(self, path, file):
        ...
        self.logger.log("[PROTOCOL_CLIENT] mando archivo completo", HIGH_VERBOSITY)   # noqa: E501
        self.connection.sendall(file_data)  # tu protocolo se encarga de fragmentar   # noqa: E501
